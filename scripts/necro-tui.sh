...
_necro_tui_left_pane() {
    ...
    echo ""
    echo -e "${DG}  ── CORE ─────────────────────${NC}"
    echo -e "${G}${B}  CANOPTEK SHELL${NC}"
    echo -e "${DG}  Hyprland compositor${NC}"
    echo -e "${G}${B}  STASIS LOCK${NC}"
    echo -e "${DG}  Hyprlock screen locker${NC}"
    echo -e "${G}${B}  SIGNAL ARRAY${NC}"
    echo -e "${DG}  Waybar status bar${NC}"
    echo -e "${G}${B}  TOMB INTERFACE${NC}"
    echo -e "${DG}  Rofi launcher${NC}"
    echo -e "${G}${B}  CORTEX NODE${NC}"
    echo -e "${DG}  Kitty terminal${NC}"
    echo -e "${G}${B}  COMMAND DIALECT${NC}"
    echo -e "${DG}  Fish shell${NC}"
    echo -e "${G}${B}  SYSTEM MANIFEST${NC}"
    echo -e "${DG}  Fastfetch readout${NC}"
    echo -e "${G}${B}  CANOPTEK ALERTS${NC}"
    echo -e "${DG}  Swaync notifications${NC}"
    echo ""
    echo -e "${DG}  ── VISUAL ────────────────────${NC}"
    echo -e "${G}${B}  DERMAL SKIN${NC}"
    echo -e "${DG}  GTK / Qt / Kvantum${NC}"
    echo -e "${G}${B}  ICONOGRAPHY${NC}"
    echo -e "${DG}  Flat Remix Necrodermis${NC}"
    echo -e "${G}${B}  TOMB MURALS${NC}"
    echo -e "${DG}  Necron wallpapers${NC}"
    echo -e "${G}${B}  PROCESS CRYPT${NC}"
    echo -e "${DG}  Btop monitor${NC}"
    echo -e "${G}${B}  RESONANCE ARRAY${NC}"
    echo -e "${DG}  Cava visualiser${NC}"
    echo -e "${G}${B}  AWAKENING GATE${NC}"
    echo -e "${DG}  SDDM login screen${NC}"
    echo -e "${G}${B}  BOOT SEQUENCE${NC}"
    echo -e "${DG}  GRUB theme${NC}"
    echo ""
    echo -e "${DG}  ── HARDENING ─────────────────${NC}"
    echo -e "${G}${B}  PERIMETER WARD${NC}"
    echo -e "${DG}  ufw firewall${NC}"
    echo -e "${G}${B}  CORTEX LOCK${NC}"
    echo -e "${DG}  Kernel hardening${NC}"
    echo ""
    echo -e "${DG}  ── EXTRAS ────────────────────${NC}"
    echo -e "${G}${B}  ATMOSPHERIC DATA${NC}"
    echo -e "${DG}  Sitrep / METAR weather${NC}"
    echo -e "${G}${B}  COMMS RELAY${NC}"
    echo -e "${DG}  Brave browser${NC}"
    echo -e "${G}${B}  ARCHIVE INTERFACE${NC}"
    echo -e "${DG}  Thunar file manager${NC}"
    echo -e "${G}${B}  DYNASTY COMMS${NC}"
    echo -e "${DG}  Vesktop / Discord${NC}"
    echo -e "${G}${B}  RECREATION ARRAY${NC}"
    echo ""
    echo -e "${DG}  ─────────────────────────────${NC}"
...
necro_tui_launch() {
    ...
    tmux set-option -t "$NECRO_TUI_SESSION" status-left \
        "#[fg=colour2,bold]  ${version}  //  NECRODERMIS  //  AWAKENING SEQUENCE  "
