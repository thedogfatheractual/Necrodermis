...
ColumnLayout {
    ...
    // ── NECRODERMIS LORE WATERMARKS ──
    // Anchored to root (full screen), not the Column flow
    // Opacity tuned to be readable on close inspection, imperceptible at a glance
    ...
    Text {
        ...
        text: "CANOPTEK SYSTEMS ONLINE  //  AWAITING BIOMATTER IDENTIFICATION"
    ...
    Text {
        ...
        text: "THE SILENT KING WATCHES  //  THE SCARABS GATHER"
        color: config.DateTextColor
        font.pointSize: root.font.pointSize * 0.75
        font.family: config.Font
        font.letterSpacing: 2
